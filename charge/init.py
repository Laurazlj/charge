...
def load_data_and_labels_fewshot():
	path = os.getcwd()
	data_path = "/mnt/d/jjpeng/ljzhao/data/"
	vec_path = data_path + "words.vec"
	train_path = "/mnt/d/jjpeng/ljzhao/data/" + "train"
	test_path = "/mnt/d/jjpeng/ljzhao/data/" + "test"
	val_path = 	"/mnt/d/jjpeng/ljzhao/data/" + "valid"
